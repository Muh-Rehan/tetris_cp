...
#import dataframe
rumah_5kota = pd.read_csv('dataset/rumah_5kota.csv')
ihpr = pd.read_csv('dataset/ihpr.csv', delimiter=';')
inflasi = pd.read_csv('dataset/inflasi.csv', delimiter=';')
upah_bulanan = pd.read_csv('dataset/upah_bulanan_indo.csv', delimiter=';', index_col='tahun')
ump_jkt = pd.read_csv('dataset/ump_jakarta.csv', delimiter=';')
kpr_bi7drr = pd.read_csv('dataset/kpr_bi7drr.csv', delimiter=';')
alasan = pd.read_csv('dataset/alasan_blm_punya_rumah.csv', delimiter=';')
